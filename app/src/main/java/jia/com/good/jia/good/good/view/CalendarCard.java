package jia.com.good.jia.good.good.view;
...
import jia.com.good.jia.good.jia.com.util.DateUtil;
...
public class CalendarCard extends View {
    ...
    public interface OnCellClickListener {
        ...
        void showDate(CustomDate date); // 回调滑动ViewPager改变的日期
    }
        ...
        public void drawSelf(Canvas canvas) {
            ...
            switch (state) {
                ...
                case CURRENT_MONTH_DAY: // 当前月日期
                        mCellClickListener.showDate(date);
                ...
                case CLICKED: // 点中的日期
                    mTextPaint.setColor(Color.parseColor("#fffffe"));
                    mCirclePaint.setColor(Color.parseColor("#7fffd4")); // 绿色圆形
                    canvas.drawCircle((float) (mCellSpace * (i + 0.5)),
                            (float) ((j + 0.5) * mCellSpace), mCellSpace / 3,
                            mCirclePaint);
                    mCirclePaint.setColor(Color.parseColor("#F24949")); // 红色圆形
     ...
     */
    enum State {
        TODAY, CURRENT_MONTH_DAY, PAST_MONTH_DAY, NEXT_MONTH_DAY, UNREACH_DAY, CLICKED;
    }
